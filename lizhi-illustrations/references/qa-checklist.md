...
- 左上角有“定义图 / 对比图 / 流程图 / 路线图”等标题。
- Lizhi 像吉祥物、表情包或可爱卡通。
- Lizhi 的固定斑块变成随机小点、波点、条纹或左右完全对称图案。
- 画面像 PPT、课程课件、正式流程图。
- 元素太多、箭头太多、节点太多。
- 文字变成大段解释。
- 背景有纸纹、阴影、渐变、米色、噪点。
