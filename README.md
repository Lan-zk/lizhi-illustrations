...
下面四张图是为《西敏小要理问答》前四问生成的解析配图，用来说明这个 skill 的视觉语言和结构类型。

### 第1问：人生的首要目的

> **问：人生的首要目的是什么？**
> 答：荣耀神，永远因祂而喜乐，这就是人生的首要目的。

![人生的首要目的](examples/images/01-chief-end-of-man.png)

### 第2问：荣耀神与喜乐的准则

> **问：神赐给我们什么准则，来指导我们荣耀神、因祂而喜乐？**
> 答：指导我们荣耀神、因祂而喜乐的唯一准则，就是包含在旧约和新约圣经中的神的话。

![荣耀神与喜乐的准则](examples/images/02-rule-of-scripture.png)

### 第3问：圣经主要教导了什么

> **问：圣经主要教导了什么？**
> 答：圣经主要教导了：一、关于神，人应该相信什么；二、对于人，神赋予了他们什么责任。

![圣经主要教导了什么](examples/images/03-scripture-teaches.png)

### 第4问：神是一位什么样的神

> **问：神是一位什么样的神？**
> 答：神是个灵。祂的各种属性，就是存有、智慧、能力、圣洁、公义、慈爱和信实，都是无限的，永恒的，且不变的。

![神是一位什么样的神](examples/images/04-what-god-is.png)

这些图片用于校准线条密度、留白、颜色克制和角色参与方式。使用时应该从当前文本重新发明隐喻，不要照抄案例的物件和构图。
...
```bash
git clone https://github.com/Lan-zk/lizhi-illustrations.git
cd lizhi-illustrations
```
...
cp -R ./lizhi-illustrations "${CODEX_HOME:-$HOME/.codex}/skills/"
```

安装后，在 Codex 里使用：

```text
Use $lizhi-illustrations 为这条要理问答设计并生成一张 Lizhi 怪诞解析配图。
```
...
```text
Use $lizhi-illustrations 为“<概念或命题>”生成一张解析配图。
...
```text
Use $lizhi-illustrations 帮我编辑这张图，去掉左上角的“定义图”标题，其他内容保持不变。
```
...
6. 让 Lizhi 承担核心动作
7. 每张图单独调用图像模型生成
8. 按 QA checklist 检查：白底、留白、Lizhi 动作、中文标注、非 PPT 感、非案例复刻
9. 保存最终 PNG，并报告用途和路径
...
├── examples/
│   ├── images/
│   │   ├── 01-chief-end-of-man.png
│   │   ├── 02-rule-of-scripture.png
│   │   ├── 03-scripture-teaches.png
│   │   └── 04-what-god-is.png
│   └── prompts.md
└── lizhi-illustrations/
    ├── SKILL.md
